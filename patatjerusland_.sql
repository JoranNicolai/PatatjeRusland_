...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/original/css/theme.css?v=5.1.3&nocache=3936147526ltr&server=1">
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="4c5c496e325057435349417d686f2334">
...
<p>index.php: Missing parameter: what<a href="./doc/html/faq.html#faqmissingparameters" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a><br>index.php: Missing parameter: export_type<a href="./doc/html/faq.html#faqmissingparameters" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a><br></p>
  ...
  <div class="clearfloat" id="pma_errors">
    <div class="alert alert-danger" role="alert"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_error"> Error reading structure for table patatjerusland_.resevation: #1932 - Table &amp;#039;patatjerusland_.resevation&amp;#039; doesn&amp;#039;t exist in engine</div><div class="alert alert-danger" role="alert"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_error"> Error reading data for table patatjerusland_.resevation: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near &amp;#039;FROM `patatjerusland_`.`resevation`&amp;#039; at line 1</div><div class="alert alert-danger" role="alert"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_error"> Error reading structure for table patatjerusland_.search: #1932 - Table &amp;#039;patatjerusland_.search&amp;#039; doesn&amp;#039;t exist in engine</div><div class="alert alert-danger" role="alert"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_error"> Error reading data for table patatjerusland_.search: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near &amp;#039;FROM `patatjerusland_`.`search`&amp;#039; at line 1</div>
  </div>
